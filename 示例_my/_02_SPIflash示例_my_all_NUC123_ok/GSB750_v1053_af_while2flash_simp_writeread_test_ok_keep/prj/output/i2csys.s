...
|L2.242|
        ...
        STRB     r0,[r1,#0]
        MOVS     r0,#0
        STR      r0,[r2,#0xc]  ; i2c_current_block
        POP      {r3-r7,pc}
|L2.284|
        LDR      r0,|L2.316|
        MOVS     r1,#0
...
i2cSpirit PROC
        ...
        LDR      r0,|L6.212|
        MOVS     r5,#0
        STR      r5,[r0,#0]  ; audio_detect_R
        LDR      r0,|L6.216|
        LDR      r4,|L6.220|
        STR      r5,[r0,#0]  ; audio_detect_L
        LDRB     r1,[r4,#0]  ; i2c_state
        MOVS     r6,#0xa2
        LDR      r3,|L6.224|
        CMP      r1,#0xa0
        BEQ      |L6.38|
...
|L6.38|
        BL       readI2cChain
        LDR      r0,[r4,#0xc]  ; i2c_current_block
        CMP      r0,#0
        BEQ      |L6.206|
        STRB     r6,[r4,#0]
        MOV      r6,r3
        ...
        ORRS     r0,r0,r1
        STR      r0,[r6,#0x14]
        STR      r5,[r4,#0x10]  ; repeat_time
        B        |L6.206|
|L6.70|
        LDR      r0,[r4,#0x10]  ; repeat_time
        ADDS     r0,r0,#1
        STR      r0,[r4,#0x10]  ; repeat_time
        CMP      r0,#1
        LDR      r0,[r4,#0xc]  ; i2c_current_block
        BLS      |L6.116|
        CMP      r0,#0
...
|L6.126|
        ...
        B        |L6.204|
|L6.192|
        LDR      r0,[r4,#0x14]  ; busy_time
        ADDS     r0,r0,#1
        STR      r0,[r4,#0x14]  ; busy_time
        CMP      r0,#0x14
        BLS      |L6.208|
        MOVS     r0,#0xa1
|L6.204|
