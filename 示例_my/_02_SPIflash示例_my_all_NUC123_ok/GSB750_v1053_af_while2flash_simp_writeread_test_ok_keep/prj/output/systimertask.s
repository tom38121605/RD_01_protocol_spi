...
; commandline ArmCC [--split_sections --debug -c --asm --info=totals -o.\output\systimertask.o --depend=.\output\systimertask.d --cpu=Cortex-M0 --apcs=interwork -I..\CMSIS\CM0\DeviceSupport\Nuvoton\NUC123Series -I..\CMSIS\CM0\CoreSupport -I..\INC\DrvInc -I..\INC\SysInc -IC:\Keil\ARM\RV31\INC -IC:\Keil\ARM\CMSIS\Include -D__MICROLIB --omf_browse=.\output\systimertask.crf ..\AppSrc\SysTimerTask.c]
        THUMB
        REQUIRE8
        PRESERVE8
...
|L2.26|
        LDR      r0,|L2.172|
        MOVS     r6,#0
        LDRB     r0,[r0,#0]  ; enter_standby_mode
        CMP      r0,#0
        BEQ      |L2.64|
        LDR      r0,|L2.176|
        LDR      r0,[r0,#0]
        CMP      r0,#0
        LDR      r0,[r5,#0x14]  ; enter_Standby_stop_counter
        BEQ      |L2.50|
        ADDS     r0,r0,#1
        STR      r0,[r5,#0x14]  ; enter_Standby_stop_counter
|L2.50|
        CMP      r0,#0x64
        BLS      |L2.66|
        LDR      r1,|L2.180|
        MOVS     r0,#1
        STR      r6,[r5,#0x14]  ; enter_Standby_stop_counter
        STRB     r0,[r1,#0]
        B        |L2.66|
|L2.64|
        STR      r6,[r5,#0x14]  ; enter_Standby_stop_counter
...
|L2.110|
        ...
        LDR      r0,|L2.196|
        LDR      r2,[r5,#0x10]  ; audio_R
        LDR      r3,[r0,#0]  ; audio_detect_R
        ADDS     r2,r2,r3
        STR      r2,[r5,#0x10]  ; audio_R
        STR      r6,[r0,#0]  ; audio_detect_R
        STR      r6,[r1,#0]  ; audio_detect_L
        BL       i2cSpirit
        POP      {r3-r7,pc}
        ENDP
...
|L2.168|
        DCD      0x00002710
|L2.172|
        DCD      enter_standby_mode
|L2.176|
        DCD      0x50004260
|L2.180|
        DCD      enter_Standby_stop
|L2.184|
        DCD      ||.bss||
|L2.188|
        DCD      0x400e0000
...
|L9.6|
        SUBS     r0,r0,#1
        STR      r3,[r1,#4]  ; delay_us
        B        |L9.18|
|L9.12|
        LDR      r2,[r1,#4]  ; delay_us
        ADDS     r2,r2,#1
        STR      r2,[r1,#4]  ; delay_us
|L9.18|
        LDR      r2,[r1,#4]  ; delay_us
        CMP      r2,#5
        BCC      |L9.12|
...
enter_Standby_stop_counter
        ...
        EXPORT enter_Standby_stop_counter [DATA,SIZE=4]

        IMPORT ||Lib$$Request$$armlib|| [CODE,WEAK]
        IMPORT logEvent [CODE]
        IMPORT i2cSpirit [CODE]
        IMPORT enter_standby_mode [DATA]
        IMPORT enter_Standby_stop [DATA]
