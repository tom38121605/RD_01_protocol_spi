...
#define ENABLE_GPIO_IR()	{	;\
							GPIO_SET_MODE(PB, 6, GPIO_INPUT); \
							GPIO_EnableInt(PB, 6, GPIO_INT_RISING); \
							GPIO_ENABLE_DEBOUNCE(PB,6);\
							GPIO_SET_DEBOUNCE_TIME(GPIO_DBCLKSRC_HCLK, GPIO_DBCLKSEL_1024); \
							NVIC_SetPriority (GPAB_IRQn, IR_INT_PRIORITY); \
							NVIC_EnableIRQ(GPAB_IRQn); \
						}          //ma  20150910  IR  always low 
...
#define IR_KEY_RELAX_TIME	3	// ir key should relax at least  IR_KEY_RELAX_TIME*IR_KEY_SCANF_RATE
...
#define IR_CUSTTOMER_CODE	 0Xff00 //0X42BA
#define IR_K1				 0X0b //0X12  // 0Xed power
#define IR_K2				 0X10 //0Xbd  // 0X42
#define IR_K3				 0X0d //0X60  // 0X9f +
#define IR_K4				 0X0e //0X61  // 0X9e -
#define IR_K5				 0X61  // 0X15	multiroom
#define IR_K6				 0X60  // 0X97	mute
#define IR_K7				 0X51  // 0X96
#define IR_K8				 0X06  // 0X95
#define IR_K9				 0X09  // 0X94
#define IR_K10				 0X08  // 0X93
#define IR_K11			   0X11   //fatory key left
#define IR_K12				 0X19   //fatory key right
#define IR_K13				 0X94
#define IR_K14				 0X93

	/******add  for ir  LAB test MODE ****/  //20150720 
#define	LAB_BT_MODE_KEY         				 0X8C
#define	LAB_BT_PAIRING_MODE_KEY     		 0X4C
#define	LAB_OPTICAL_MODE_KEY        		 0X2C
#define	LAB_LINE_IN_MODE_KEY             0XAC
#define	LAB_NET_WORK_RX_MODE_KEY         0X6C
#define	LAB_VOL_MAX_KEY        		       0X82
#define	LAB_SPEAK_1_KEY        		       0X42
#define	LAB_SPEAK_2_KEY        		       0XC2
#define	LAB_SPEAK_3_KEY        		       0XA2
#define	LAB_SPEAK_4_KEY         	       0X8A
#define	LAB_SPEAK_5_KEY         	 	      0X4A
#define	LAB_SPEAK_ALL_KEY        	    	  0X2A
#define LAB_DEFAULT_MODE_KEY             0X6A
#endif
...
/****ir key volue tese***/
extern u8 ir_key_volue;    //ma 20150618 

extern void IR_IRQHandler(void);     //ma 20150629  declare  IR_IRQHandler

/*****add  ir_key_scan_flag ****/
// extern u8 ir_key_scan_flag;      //ma 20150702   
extern u8 ir_key_flag;        //ma 20150728  add ir_key flag 
#endif
