...
//	SPI_SET_DIVIDER(SPI2, 12); //SPIclk = 2.7xx MHZ
//	
...
//int readfromspi(u16 headerLength, const u8 *headerBuffer, u32 bodylength, u8 *bodyBuffer )
//{
//	u32 index = 0;
//	
//	SPI_CLR_SS0(SPI2);
...
//	{
//		spiSendWord(headerBuffer[index], 8);
//	}
//	SPI_ENABLE_REORDER(SPI2);
//	for(index = 0 ; index < bodylength; index++)
//	{
//		spiSendWord(0xff,8);
//		bodyBuffer[index] = SPI2->RX[0];
//	}
//	SPI_CLR_SS0(SPI2);
//	
//	return 0;
