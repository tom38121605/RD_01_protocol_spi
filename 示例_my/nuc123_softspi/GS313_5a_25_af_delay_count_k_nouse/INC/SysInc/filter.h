...
#define L_IIR32(n,sumL, sumR,Rshift) IIR24_24_Module(x##n##_L1, x##n##_L2, x##n##_L3, sumL, sumR, y##n##_L2, y##n##_L3,\
							F_L_K##n##1, F_L_K##n##2, F_L_K##n##3, F_L_K##n##4, F_L_K##n##5, Rshift)

#define R_IIR32(n,sumL, sumR,Rshift) IIR24_24_Module(x##n##_R1, x##n##_R2, x##n##_R3, sumL, sumR, y##n##_R2, y##n##_R3,\
							F_L_K##n##1, F_L_K##n##2, F_L_K##n##3, F_L_K##n##4, F_L_K##n##5, Rshift)
