...
void delay_count_time(u32 i, u32 j);
...
//// 	  u8 ibuf1[4]={0x28,0x28,0x28,0x28};		
//// 	  u8 ibuf2[4]={0,0,0,0};
////		
////		//dwt_writetodevice(0x03,0,1,ibuf1);
////		
////		dwt_readfromdevice(0x03,0,2,ibuf2);
////		uartdecode(ibuf2[0] ,"  ibuf2: ");

		deca_sleep(1);		
		delay_count_time(0,0);  //0.95us
//		delay_count_time(1,1);  //1.4us
//		delay_count_time(2,2);  //2us
//		delay_count_time(5,5);  //6us
//		delay_count_time(100,100);  //1.4ms
//		delay_count_time(1000,1000);  //135ms
