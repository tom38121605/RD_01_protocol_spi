...
extern int readfromspi(u16 headerLength, const u8 *headerBuffer, u32 readlength, u8 *readBuffer);
extern u16 writetospi( u16 headerLength, const u8 *headerBuffer, u32 bodylength, const u8 *bodyBuffer);
...
s32 _dwt_otpprogword32(uint32 data, uint16 address);
...
s32 _dwt_otpsetmrregs(int mode)
{
    uint8 rd_buf[4];
    uint8 wr_buf[4];
...
int dwt_starttx(uint8 mode)
{
    ...
    if (mode & DWT_START_TX_DELAYED)
    {
        ...
        {
//uartdecodeH32(checkTxOK,"  checkTxOK: ");
...
//uartdecodeH32(checkTxOK,"  checkTxerr: ");					
