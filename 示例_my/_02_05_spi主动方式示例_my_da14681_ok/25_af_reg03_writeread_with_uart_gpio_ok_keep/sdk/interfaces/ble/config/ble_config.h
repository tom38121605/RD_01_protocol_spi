 ...
 *
 * Minimum length for Connection Event in steps of 0.625ms.
 *
 * \note This is used in outgoing connection requests, connection parameter requests and
 *       connection updates.
 *
 * \bsp_default_note{\bsp_config_option_app, \bsp_config_option_expert_only}
 */
#ifndef dg_configBLE_CONN_EVENT_LENGTH_MIN
#define dg_configBLE_CONN_EVENT_LENGTH_MIN   (BLE_CONN_EVENT_LENGTH_FROM_MS(0))
#endif

/** \brief Maximum Connection Event Length
 *
 * Maximum length for Connection Event in steps of 0.625ms.
 *
 * \note This is used in outgoing connection requests, connection parameter requests and
 *       connection updates.
 *
...
#define dg_configBLE_CONN_EVENT_LENGTH_MAX   (BLE_CONN_EVENT_LENGTH_FROM_MS(125))
#endif
